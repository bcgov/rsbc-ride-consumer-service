...
//        LinkedHashMap<String, Object> map = (LinkedHashMap<String, Object>) event;
...
//        }
        ...
        // logger.info("Payload: {}", event.ticket_number);
    //    evtissuanceeevent evt = (evtissuanceeevent) event;
        ...
        try {
            ...
            String eventString = event.substring(6);
            logger.info("Payload: {}", eventString);
            ObjectMapper objectMapper = new ObjectMapper();
            evtissuanceeevent evt = objectMapper.readValue(event, evtissuanceeevent.class);
